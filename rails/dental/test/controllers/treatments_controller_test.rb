...
class TreatmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create treatment" do
    assert_difference('Treatment.count') do
      post treatments_url, params: { treatment: { description: @treatment.description } }, as: :json
    end
  ...
  test "should update treatment" do
    patch treatment_url(@treatment), params: { treatment: { description: @treatment.description } }, as: :json
    assert_response 200
  end
